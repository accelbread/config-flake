...
(custom-theme-set-faces
 ...
 ;; 6-point in-gamut OKLCH optimum: L=.736545, C=.146286
 '(rainbow-delimiters-depth-1-face ((t (:foreground "#A898FE"))))
 '(rainbow-delimiters-depth-2-face ((t (:foreground "#00B9F3"))))
 '(rainbow-delimiters-depth-3-face ((t (:foreground "#00C69A"))))
 '(rainbow-delimiters-depth-4-face ((t (:foreground "#B0B02C"))))
 '(rainbow-delimiters-depth-5-face ((t (:foreground "#F18B4D"))))
 '(rainbow-delimiters-depth-6-face ((t (:foreground "#EC80B7"))))
...
(defun configure-eglot-mode ()
  "Handle setup/teardown of custom eglot config."
  (if (eglot-managed-p)
...
(add-hook 'typst-ts-mode-hook #'enable-eglot)
...
(add-hook 'nix-mode-hook #'enable-eglot)
...
(add-hook 'yaml-ts-mode-hook #'enable-eglot)


;;; Toml

(set-lsp-server 'toml-ts-mode '("tombi" "lsp"))
(add-hook 'toml-ts-mode-hook #'enable-eglot)
